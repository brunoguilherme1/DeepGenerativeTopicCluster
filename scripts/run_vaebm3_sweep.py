#!/usr/bin/env python
"""Durable, resumable driver for the 3-VAE-BM-variant x 5-hicot-dataset
...
Datasets: HiCOT's own official 5-dataset benchmark suite (hicot_20ng,
hicot_imdb, hicot_agnews, hicot_search_snippets, hicot_google_news) -
"all hicot datasets" per this sweep's own request, not the full 26-id
cluster registry.

Usage:
    python scripts/run_vaebm3_sweep.py                      # start a new run
    python scripts/run_vaebm3_sweep.py --run-dir results/vaebm3_hicot_20260916_120000  # resume
"""
...
DATASETS = ["hicot_20ng", "hicot_imdb", "hicot_agnews", "hicot_search_snippets", "hicot_google_news"]
SEED = 42
...
class Sweep:
    ...
    def build_final_outputs(self) -> None:
        ...
        combined_txt = render_cluster_table(results, datasets_per_block=5)
...
def main() -> None:
    ...
    if args.run_dir:
        ...
        run_dir = REPO_ROOT / "results" / f"vaebm3_hicot_{timestamp}"
